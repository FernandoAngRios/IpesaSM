...
@section('title', 'Nuevo Usuario — IPESA SM')
...
<div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
    ...
    <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
        ...
        <h2 class="font-bold text-gray-900">Crear nuevo usuario</h2>
    </div>

    <form action="{{ route('empleados.usuarios.store') }}" method="POST">
        @csrf
        ...
        <div class="px-6 py-6 space-y-5">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <button type="button" onclick="togglePwd('create_password', this)"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <button type="button" onclick="togglePwd('create_password_confirmation', this)"
                            class="absolute inset-y-0 right-0 flex items-center px-3 text-gray-400 hover:text-gray-600 transition-colors" tabindex="-1">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
